...
// Route to create a new application (no multer since resume will be uploaded via Cloudinary)
...
router.put('/shortlist/:id', applicationController.updateShortlistStatus);
